    ...
    if op==1:
        ...
        if op2==1:
            ...
            while True:
                ...
                if controle == 1:
                    ...
                    taxa_comissao = int (input("Digite quantos % voce cobra pela consultoria"))
                    comissao = 0
                    print('Muito obrigado(a) pela paciência ' + str(nome) + '! \nO cadastro foi realizado com sucesso!')
                    break
        elif op2==4:
        ...
        if menu==3:
            ...
            if op4 == 1:
                print('='*30)
                input()
                print("\n\tVoce tem a pagar pelo software o valor de:",preco_software)
                comissao += ((taxa_comissao/100) * (int(preco_software)))
                print("O consultor de comissão receberá o valor de:",comissao)
        ...
        while True:
            ...
            print('\nProjeto Integrador')
            print('\nPython Bridge é o nosso nome, pois o nosso propósito é fazer a ponte entre todos os stakeholders envolvidos na aquisição de um software: os fornecedores, os clientes e os consultores. Para criarmos esse nome, partimos da ideia dessa conexão que promoveremos. Além disso, julgamos importante que o nome da linguagem que estamos aprendendo nesse trimestre e que iremos utilizar no desenvolvimento do nosso software aparecesse. Ademais, optamos por um nome em inglês pois além desta ser a língua mais falada no mundo, a maior parte das linguagens de programação, dos softwares e dos componentes de hardware são feitos em inglês.')
            print('=' * 30)
            input()
            break
    elif op==4:
        while True:
            print('='*30)
            input()
            print('\n\nOlá, atenção: você tem de comissão a receber:',comissao)
            print('\nOlá consultor com nome:',nome,'\nSeu cpf é:',cpf,'\nSeu telefone é:',telefone,'\nSeu email é:email,'\nSua formacao é:',formacao,'\nSua experiencia é:',experiencia,'\nSua taxa de comissão é:',taxa_comissao)
